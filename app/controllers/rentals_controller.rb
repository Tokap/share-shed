class RentalsController < ApplicationController
  ...
  def create
    ...
    # second condition added to keep tool owner from renting from himself.
      ...
      @rental.save
      flash[:notice]= "<p>You have created a new rental request with #{@rental.owner.username}. Click <a href='/users/#{@rental.owner.id}'>here</a> to shop for more tools from them.</p>"
