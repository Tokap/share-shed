 ...
 * Note: Beforehand, you will need to set staging as heroku git remote repositories.
 * Note: Optional tasks for dropping and recreating the database are noted below.
 ...
 3. (optional) heroku pg:reset DATABASE --app shedsharing-stage --confirm shedsharing-stage
 ...
 * Note: Beforehand, you will need to set prod as heroku git remote repositories.
 * Note: Optional tasks for dropping and recreating the database are noted below.
 1. git pull origin development
 2. git push prod master
 3. (optional) heroku pg:reset DATABASE --app shedsharing --confirm shedsharing
 4. (optional) heroku run rake db:migrate --remote prod
 5. (optional) heroku run rake db:seed --remote prod
 6. http://www.shedsharing.com
